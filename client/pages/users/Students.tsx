...
// Comprehensive student interface based on your JSON structure
interface ComprehensiveStudent {
  id: string;
  full_name: string;
  email: string;
  roll_number: string;
...
// Form data interface
interface ComprehensiveStudentFormData {
  full_name: string;
  email: string;
  roll_number: string;
  institution: string;
...
export default function Students() {
  ...
  const handleCreateComprehensiveStudent = () => {
    ...
    const newStudent: Student = {
      ...
      status: formData.status.toLowerCase() as "active" | "inactive" | "graduated",
      avatar: "",
      // Add educational authority as additional property
      ...(formData.educational_authority && { educationalAuthority: formData.educational_authority }),
    };
  ...
  // Render comprehensive add student form
  if (viewMode === "add") {
    return (
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Complete student registration form with all required information
              </p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="p-6">
            <Tabs defaultValue="basic" className="w-full">
              ...
              <TabsContent value="academic" className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium">Educational Authority</label>
                    <Select
                      value={formData.educational_authority}
                      onValueChange={(value) => setFormData({ ...formData, educational_authority: value })}
                    >
                      <SelectTrigger>
            ...
            <div className="flex justify-end gap-4 mt-8">
              ...
              <Button onClick={handleCreateComprehensiveStudent}>
                Add Student
              </Button>
            </div>
          </CardContent>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" onClick={openAddStudentForm}>
