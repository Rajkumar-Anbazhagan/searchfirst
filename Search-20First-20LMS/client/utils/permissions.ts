...
export type ResourceType = 
  ...
  | 'entity_setup' | 'academic_year' | 'program_setup' | 'stream_course_mapping'
  | 'term_semester' | 'subject_master' | 'registration_form' | 'user_roles'
  | 'staff_roles' | 'staff_allotment'
  
  // User Management Resources
  | 'administrators' | 'faculty_members' | 'student_records' | 'system_permissions'
  
  // Academic Resources
  | 'students' | 'curriculum' | 'timetable' | 'lesson_plans' | 'attendance'
  | 'feedback' | 'scholarships' | 'dropouts' | 'calendar' | 'notifications'
  | 'service_requests'
  
  // LMS Resources
  | 'courses' | 'assignments' | 'assessments' | 'progress' | 'lessons'
  | 'cohorts' | 'discussion_forums' | 'certificates' | 'virtual_classrooms'
  | 'lms_reports'
  
  // Examination Resources
  | 'exam_planning' | 'exam_eligibility' | 'hall_tickets' | 'question_bank'
  | 'paper_blueprint' | 'paper_generation' | 'invigilators' | 'seating_plan'
  | 'evaluation' | 'results' | 'revaluation' | 'transcripts' | 'exam_reports'
...
export const rolePermissions: Record<UserRole, Permission[]> = {
  'super-admin': [
    ...
    { resource: 'entity_setup', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'academic_year', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'program_setup', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'stream_course_mapping', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'term_semester', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'subject_master', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'registration_form', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'user_roles', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'staff_roles', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'staff_allotment', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'administrators', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'faculty_members', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'student_records', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'system_permissions', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'students', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'curriculum', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'timetable', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'lesson_plans', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'attendance', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'feedback', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'scholarships', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'dropouts', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'calendar', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'notifications', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'service_requests', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'courses', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'assignments', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'assessments', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'progress', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'lessons', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'cohorts', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'discussion_forums', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'certificates', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'virtual_classrooms', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'lms_reports', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'exam_planning', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'exam_eligibility', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'hall_tickets', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'question_bank', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'paper_blueprint', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'paper_generation', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'invigilators', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'seating_plan', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'evaluation', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'results', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'revaluation', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'transcripts', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'exam_reports', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'proctoring', operations: ['create', 'read', 'update', 'delete'] },
    { resource: 'analytics', operations: ['create', 'read', 'update', 'delete'] },
  ...
  faculty: [
    ...
    { resource: 'lesson_plans', operations: ['create', 'read', 'update', 'delete'] }, // Full access to their lesson plans
    ...
    // LMS Resources - Teaching focused
    { resource: 'courses', operations: ['create', 'read', 'update'] }, // Can manage their courses
    { resource: 'assignments', operations: ['create', 'read', 'update', 'delete'] }, // Full access to assignments
    { resource: 'assessments', operations: ['create', 'read', 'update', 'delete'] }, // Full access to assessments
    ...
    { resource: 'virtual_classrooms', operations: ['create', 'read', 'update'] }, // Can manage classrooms
  ...
  student: [
    ...
    // LMS Resources - Learning focused
    { resource: 'courses', operations: ['read'] }, // View enrolled courses
  ...
  hod: [
    ...
    // Full LMS access for department management
    { resource: 'courses', operations: ['create', 'read', 'update'] },
    ...
    { resource: 'virtual_classrooms', operations: ['create', 'read', 'update'] },
  ...
  staff: [
    ...
    { resource: 'courses', operations: ['read'] },
  ...
  parent: [
    ...
    { resource: 'courses', operations: ['read'] }, // View child's courses
...
export const canCreate = (userRole: UserRole, resource: ResourceType): boolean => 
...
export const canUpdate = (userRole: UserRole, resource: ResourceType): boolean => 
  hasPermission(userRole, resource, 'update');

export const canDelete = (userRole: UserRole, resource: ResourceType): boolean => 
