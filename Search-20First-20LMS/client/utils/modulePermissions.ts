...
export const specialModuleConfig = {
  'master-setup': {
    // Master Setup is only accessible to super-admin and admin
    allowedRoles: ['super-admin', 'admin'] as UserRole[],
    description: 'Master Setup provides access to all system modules and configurations',
    requiresSpecialPermission: true,
    // When accessing master-setup, super-admin can see all modules
