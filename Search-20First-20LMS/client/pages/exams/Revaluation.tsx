...
export default function Revaluation() {
  ...
  const [availableEvaluators] = useState([
    { id: 'FAC002', name: 'Prof. Michael Chen', subjects: ['Computer Science', 'Mathematics'], rating: 4.9 },
    { id: 'FAC003', name: 'Dr. Emily Rodriguez', subjects: ['Mathematics', 'Physics'], rating: 4.8 },
    { id: 'FAC005', name: 'Dr. James Wilson', subjects: ['Computer Science', 'Engineering'], rating: 4.7 },
    { id: 'FAC006', name: 'Prof. Lisa Anderson', subjects: ['Physics', 'Chemistry'], rating: 4.9 }
  ]);
