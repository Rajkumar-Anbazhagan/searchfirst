        ...
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              {[
                {
                  student: { name: 'Bob Smith', reg: 'CS2024002', attendance: 65 },
                  subject: 'Data Structures',
                ...
                {
                  student: { name: 'Carol Davis', reg: 'CS2024003', attendance: 72 },
                  subject: 'Operating Systems',
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold text-blue-900">Alice Johnson</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-3 p-3 border rounded">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">academic@university.edu</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 border rounded">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 p-3 border rounded">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Prof. Johnson: +91 9876543211</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 border rounded">
                    <Phone className="h-5 w-5 text-blue-600" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 border rounded">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">parents@university.edu</p>
