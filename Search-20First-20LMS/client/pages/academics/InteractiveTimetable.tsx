...
const initialTimetableData: TimetableData = {
  'CSE - Year 1': {
    'Monday': [
      { subject: 'Data Structures', teacher: 'Dr. Smith', room: 'Room 101', duration: 60, type: 'regular', workload: 4 },
      { subject: 'Mathematics', teacher: 'Prof. Johnson', room: 'Room 102', duration: 60, type: 'regular', workload: 6 },
      { subject: 'Physics Lab', teacher: 'Dr. Brown', room: 'Lab 201', duration: 120, type: 'lab', workload: 3 },
      { subject: 'Lunch Break', teacher: '', room: '', duration: 60, type: 'break', workload: 0 },
      { subject: 'Operating Systems', teacher: 'Mr. Wilson', room: 'Room 103', duration: 60, type: 'flexible', alternateTeachers: ['Dr. Davis', 'Ms. Garcia'], workload: 5 },
      { subject: 'Software Engineering', teacher: 'Dr. Davis', room: 'Room 104', duration: 60, type: 'regular', workload: 4 }
    ],
    'Tuesday': [
      { subject: 'Algorithms', teacher: 'Dr. Smith', room: 'Room 101', duration: 60, type: 'regular', workload: 4 },
      { subject: 'Database Systems', teacher: 'Ms. Garcia', room: 'Room 205', duration: 60, type: 'regular', workload: 5 },
      { subject: 'Computer Networks', teacher: 'Mr. Taylor', room: 'Room 106', duration: 60, type: 'regular', workload: 3 },
      { subject: 'Lunch Break', teacher: '', room: '', duration: 60, type: 'break', workload: 0 },
      { subject: 'Machine Learning', teacher: 'Dr. Wilson', room: 'Lab 301', duration: 120, type: 'lab', workload: 6 },
      { subject: 'Ethics in Computing', teacher: 'Prof. Brown', room: 'Room 107', duration: 60, type: 'regular', workload: 2 }
    ],
    'Wednesday': [
      { subject: 'Web Development', teacher: 'Ms. Garcia', room: 'Lab 202', duration: 120, type: 'lab', workload: 5 },
      { subject: 'Discrete Mathematics', teacher: 'Prof. Johnson', room: 'Room 102', duration: 60, type: 'regular', workload: 6 },
      { subject: 'Computer Architecture', teacher: 'Dr. Davis', room: 'Room 108', duration: 60, type: 'regular', workload: 4 },
      { subject: 'Lunch Break', teacher: '', room: '', duration: 60, type: 'break', workload: 0 },
      { subject: 'Mobile App Development', teacher: 'Mr. Wilson', room: 'Lab 302', duration: 120, type: 'flexible', alternateTeachers: ['Dr. Smith', 'Ms. Garcia'], workload: 5 },
      { subject: 'Technical Writing', teacher: 'Dr. Brown', room: 'Room 109', duration: 60, type: 'regular', workload: 2 }
    ],
    'Thursday': [
      { subject: 'AI Fundamentals', teacher: 'Dr. Wilson', room: 'Room 110', duration: 60, type: 'regular', workload: 6 },
      { subject: 'Statistics', teacher: 'Prof. Johnson', room: 'Room 102', duration: 60, type: 'regular', workload: 6 },
      { subject: 'Cybersecurity', teacher: 'Dr. Davis', room: 'Lab 203', duration: 120, type: 'lab', workload: 4 },
      { subject: 'Lunch Break', teacher: '', room: '', duration: 60, type: 'break', workload: 0 },
      { subject: 'Project Management', teacher: 'Ms. Garcia', room: 'Room 111', duration: 60, type: 'regular', workload: 5 },
      { subject: 'Research Methodology', teacher: 'Dr. Brown', room: 'Room 112', duration: 60, type: 'regular', workload: 2 }
    ],
    'Friday': [
      { subject: 'Software Testing', teacher: 'Dr. Smith', room: 'Lab 204', duration: 120, type: 'lab', workload: 4 },
      { subject: 'Human-Computer Interaction', teacher: 'Ms. Garcia', room: 'Room 113', duration: 60, type: 'regular', workload: 5 },
      { subject: 'Cloud Computing', teacher: 'Mr. Taylor', room: 'Room 114', duration: 60, type: 'flexible', alternateTeachers: ['Dr. Wilson', 'Dr. Davis'], workload: 3 },
      { subject: 'Lunch Break', teacher: '', room: '', duration: 60, type: 'break', workload: 0 },
      { subject: 'Capstone Project', teacher: 'Dr. Wilson', room: 'Project Lab', duration: 120, type: 'regular', workload: 6 },
...
export default function InteractiveTimetable() {
  ...
  const teacherOptions = [
    ...
    { value: 'Prof. James', label: 'Prof. James (Mathematics)' },
