...
const mockReports = {
  ...
  attendance: [
    ...
    { studentId: 'STU2024002', name: 'Priya Sharma', class: 'CSE-A', totalDays: 100, presentDays: 88, percentage: 88 },
  ...
  scholarships: [
    ...
    { studentId: 'STU2024002', name: 'Priya Sharma', scheme: 'Girl Child Education', amount: 35000, status: 'Under Review' },
