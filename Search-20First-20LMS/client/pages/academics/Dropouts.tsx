...
const initialDropoutData = [
  { id: 'ST045', name: 'David Thompson', grade: '11', reason: 'Family relocation', date: '2024-01-10', contact: '+1-234-567-8901', status: 'Transferred', email: 'david.thompson@email.com', guardian: 'Mrs. Thompson', interventions: [] },
  { id: 'ST098', name: 'Emma Rodriguez', grade: '10', reason: 'Financial difficulties', date: '2023-12-15', contact: '+1-234-567-8902', status: 'At Risk', email: 'emma.rodriguez@email.com', guardian: 'Mr. Rodriguez', interventions: ['Financial counseling', 'Scholarship application'] },
  { id: 'ST156', name: 'Michael Chen', grade: '12', reason: 'Career opportunity', date: '2023-11-20', contact: '+1-234-567-8903', status: 'Dropped Out', email: 'michael.chen@email.com', guardian: 'Mrs. Chen', interventions: [] },
  { id: 'ST203', name: 'Sarah Williams', grade: '9', reason: 'Academic struggles', date: '2023-10-05', contact: '+1-234-567-8904', status: 'Intervention', email: 'sarah.williams@email.com', guardian: 'Mr. Williams', interventions: ['Tutoring program', 'Academic mentoring'] },
  { id: 'ST204', name: 'James Wilson', grade: '10', reason: 'Health issues', date: '2023-09-15', contact: '+1-234-567-8905', status: 'At Risk', email: 'james.wilson@email.com', guardian: 'Mrs. Wilson', interventions: ['Health support'] },
  { id: 'ST205', name: 'Lisa Anderson', grade: '11', reason: 'Family issues', date: '2023-08-20', contact: '+1-234-567-8906', status: 'Intervention', email: 'lisa.anderson@email.com', guardian: 'Mr. Anderson', interventions: ['Family counseling'] },
  { id: 'ST206', name: 'Robert Martinez', grade: '12', reason: 'Job opportunity', date: '2023-07-10', contact: '+1-234-567-8907', status: 'Dropped Out', email: 'robert.martinez@email.com', guardian: 'Mrs. Martinez', interventions: [] },
  { id: 'ST207', name: 'Jennifer Brown', grade: '9', reason: 'Moving abroad', date: '2023-06-25', contact: '+1-234-567-8908', status: 'Transferred', email: 'jennifer.brown@email.com', guardian: 'Mr. Brown', interventions: [] },
  { id: 'ST208', name: 'Christopher Davis', grade: '11', reason: 'Financial difficulties', date: '2023-05-30', contact: '+1-234-567-8909', status: 'At Risk', email: 'christopher.davis@email.com', guardian: 'Mrs. Davis', interventions: ['Financial aid application'] },
  { id: 'ST209', name: 'Amanda Miller', grade: '10', reason: 'Academic struggles', date: '2023-04-12', contact: '+1-234-567-8910', status: 'Intervention', email: 'amanda.miller@email.com', guardian: 'Mr. Miller', interventions: ['Study skills workshop', 'Peer tutoring'] }
];
