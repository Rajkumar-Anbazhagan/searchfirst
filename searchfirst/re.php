...
if (isset($_POST['add'])) {
    ...
    $mysqli->query("INSERT INTO course_allocation (regulation, academic_year, batch, institution_code, course_code) VALUES ('$regulation', '$academic_year', '$batch', '$institution_code', '$course_code')");
...
if (isset($_POST['edit'])) {
    ...
    $institution_code = $mysqli->real_escape_string($_POST['institution_code']);
    $course_code = $mysqli->real_escape_string($_POST['course_code']);
    $mysqli->query("UPDATE course_allocation SET regulation='$regulation', academic_year='$academic_year', batch='$batch', institution_code='$institution_code', course_code='$course_code' WHERE id=$id");
    header('Location: courses_assign.php'); exit;
}
...
<li class="sidebar-menu__item has-dropdown">
    ...
    <tr>
        ...
        <td>
            <button type="button" class="btn btn-primary btn-sm editBtn" data-id="<?= $row['id'] ?>">Edit</button>
    ...
    <div class="modal-content">
      <form id="addForm">
        ...
        <div class="modal-body">
          ...
          <input type="text" name="regulation" class="form-control mb-2" placeholder="Regulation" required>
          <input type="text" name="academic_year" class="form-control mb-2" placeholder="Academic Year" required>
          <input type="text" name="batch" class="form-control mb-2" placeholder="Batch" required>
          <input type="text" name="institution_code" class="form-control mb-2" placeholder="Institution Code" required>
    ...
    <div class="modal-content">
      <form id="editForm">
        ...
        <div class="modal-body">
          ...
          <input type="text" name="regulation" id="edit_regulation" class="form-control mb-2" required>
          <input type="text" name="academic_year" id="edit_academic_year" class="form-control mb-2" required>
          <input type="text" name="batch" id="edit_batch" class="form-control mb-2" required>
          <input type="text" name="institution_code" id="edit_institution_code" class="form-control mb-2" required>
          <input type="text" name="course_code" id="edit_course_code" class="form-control mb-2" required>
        </div>
        <div class="modal-footer">
...
<script src="assets/js/jquery-3.7.1.min.js"></script>
    ...
    $(function(){
        ...
        $('.editBtn').on('click', function(){
            ...
            $('#editAllocation').val($(this).data('allocation'));
